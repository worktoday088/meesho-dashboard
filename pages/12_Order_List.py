...
def main():
    ...
    # -------- Packet Id Filter (in-filter Select All) --------
    ...
    if 'Packet Id' in df.columns:
        ...
        packet_options = non_blank + ['Blank']  # Blank at end
    ...
    if not filters_ready:
        st.warning('रिपोर्ट देखने से पहले कृपया दोनों फ़िल्टर चुनें: Packet Id और Reason for Credit Entry. ड्रॉपडाउन के अंदर सबसे ऊपर "— Select All —" से एक क्लिक में सभी चुन सकते हैं।')
    ...
    st.success('तैयार: In-filter Select All (दोनों फ़िल्टर्स), Blank Packet Id, सुरक्षित गेटिंग, और Grand Total (right + bottom) Excel/PDF सहित लागू हो गए हैं।')
